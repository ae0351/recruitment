...
ON 
	...
	AND first_offense.`OFF_OCC_DATE`>'2005-01-01';
...
#QUERY #11
DROP TEMPORARY TABLE IF EXISTS temp_co_offender_charges;
#QUERY #12
CREATE TEMPORARY TABLE temp_co_offender_charges
SELECT 
`RECRUITER_PIN`,
`PIN` AS 'OFF_PIN',
`OCC_DATE`,
...
#QUERY #13
DROP TABLE IF EXISTS co_offender_charges;
#QUERY#14
...
CREATE TABLE co_offender_charges 
SELECT * FROM temp_co_offender_charges
GROUP BY 
	`RECRUITER_PIN`,
	`OFF_PIN`,
	`OCC_DATE`,
